...
type USDCSubscribePanelProps = {
  onClose: () => void;
};

export default function USDCSubscribePanel({
  onClose,
}: USDCSubscribePanelProps) {
  const { user } = usePrivy();
  ...
  return (
    <div className="fixed inset-0 z-[10000] bg-transparent lg:left-[262px]">
      <div className="flex h-full w-full items-center justify-center p-2 sm:p-5 lg:p-7">
        <section
          role="dialog"
          aria-modal="true"
          aria-label="USDC Earn subscription"
          className="flex h-full max-h-[calc(100dvh-16px)] w-[calc(100vw-16px)] max-w-[1160px] min-w-0 flex-col overflow-hidden rounded-[24px] border border-[#2b2b2b] bg-[#111111] text-white shadow-2xl sm:max-h-[calc(100vh-40px)] sm:w-full lg:max-h-[calc(100vh-56px)]"
        >
        <div className="flex shrink-0 items-center justify-between border-b border-[#292929] px-5 py-4 sm:px-7">
          <button
            type="button"
            onClick={onClose}
            className="inline-flex items-center gap-2 text-[13px] font-medium text-zinc-500 transition hover:text-white"
          ...
          <button
            type="button"
            onClick={onClose}
            aria-label="Close USDC Earn panel"
            className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#2b2b2b] bg-[#181818] text-zinc-500 transition hover:border-[#3a3a3a] hover:bg-[#222222] hover:text-white"
          >
            ×
          </button>
        </div>
        ...
        <main className="min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-auto">
          <div className="mx-auto w-full max-w-[1120px] min-w-0 px-3 pb-8 pt-4 sm:px-6 sm:pb-10 lg:px-8 lg:pt-7">
...
/>
            ...
            <div className="grid min-w-0 gap-4 lg:gap-5 lg:grid-cols-[1.35fr_0.65fr]">

              {/* ==================================================
                  LEFT — SUBSCRIBE FORM
              ================================================== */}

              <section className="min-w-0 rounded-[26px] border border-[#2b2b2b] bg-[#151515] p-4 sm:p-6 lg:p-7">
              ...
              <aside className="min-w-0 h-fit space-y-4 sm:space-y-5">
