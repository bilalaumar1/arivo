...
export default function EURCSubscribePanel({
  onClose,
}: {
  onClose: () => void;
}) {
  ...
  const apy = positions?.EURC?.apy ?? 0;
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      setError(
        message ||
          "EURC subscription failed. Please try again."
      );
    } finally {
      setSubmitting(false);
    }
    ...
    <div className="fixed inset-0 z-[10000] bg-transparent lg:left-[262px]">
      <div className="flex h-full w-full items-center justify-center p-2 sm:p-5 lg:p-7">
        <section
          role="dialog"
          aria-modal="true"
          aria-label="EURC Earn subscription"
        ...
        >
          ...
          <div className="mx-auto w-full max-w-[1120px] min-w-0 px-3 pb-12 pt-4 sm:px-6 sm:pb-16 sm:pt-5 lg:px-8 lg:pt-8">
            ...
            <button
              ...
              onClick={onClose}
              aria-label="Close"
              className="absolute right-5 top-5 flex h-10 w-10 items-center justify-center rounded-xl border border-[#2b2b2b] bg-[#151515] text-zinc-500 transition hover:border-[#3a3a3a] hover:bg-[#202020] hover:text-white sm:right-7 sm:top-7"
            >
              ×
            </button>
              ...
              <section className="min-w-0 rounded-[26px] border border-[#2b2b2b] bg-[#151515] p-4 sm:p-6 lg:p-7">
                ...
                <div className="mt-5 flex gap-3 rounded-[18px] border border-[#292929] bg-[#181818] p-4">
                  ...
                  <p className="text-[11px] leading-5 text-zinc-500">
                    Your EURC will be supplied to the
